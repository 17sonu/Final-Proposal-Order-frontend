...
function DashboardSummary() {
    ...
    const handleViewEstimates = () => {
        navigate('/home/omallproposal'); // Navigate to Estimates page
    };

    const handleViewSales = () => {
        navigate('/home/omallorder'); // Navigate to Sales page
    };
    ...
    const chartData = {
        ...
        datasets: [
            {
                data: [summary.totalEstimates || 4, summary.totalSales || 3],
    ...
    return (
        <div>
            <h1 className="dashboard-title">Operational Management Dashboard</h1>
            ...
            <div className="section">
                <div className="glass-box">
                    ...
                    <div className="glass-card green1">
                        ...
                        <h3>{summary.totalEstimates || 4}</h3>
                    </div>
