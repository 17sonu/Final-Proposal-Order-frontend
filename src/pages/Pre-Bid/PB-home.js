...
function DashboardSummary() {
    ...
    const handleViewEstimates = () => {
        navigate('/home/pballproposal'); // Navigate to Estimates page
    };

    const handleViewSales = () => {
        navigate('/home/pballorder'); // Navigate to Sales page
    };
    ...
    const chartData = {
        ...
        datasets: [
            {
                data: [summary.totalEstimates || 6, summary.totalSales || 6],
    ...
    return (
        <div>
            <h1 className="dashboard-title">Pre Bid Dashboard</h1>
            ...
            <div className="section">
                <div className="glass-box">
                    ...
                    <div className="glass-card green1">
                        ...
                        <h3>{summary.totalEstimates || 6}</h3>
                    </div>
