...
function DashboardSummary() {
    ...
    const handleViewEstimates = () => {
        navigate('/home/kmallproposal'); // Navigate to Estimates page
    };

    const handleViewSales = () => {
        navigate('/home/kmallorder'); // Navigate to Sales page
    };
    ...
    const chartData = {
        ...
        datasets: [
            {
                data: [summary.totalEstimates || 18, summary.totalSales || 12],
    ...
    return (
        <div>
            <h1 className="dashboard-title">Knowledge Management Dashboard</h1>
            ...
            <div className="section">
                <div className="glass-box">
                    ...
                    <div className="glass-card green1">
                        ...
                        <h3>{summary.totalEstimates || 18}</h3>
                    </div>
